package net.systemeD.halcyonpdf.styleparser {
	...
	/** A Style is a set of graphic properties (e.g. stroke colour and width, casing colour and width, 
		...
		@see net.systemeD.halcyonpdf.styleparser.StyleList
		@see net.systemeD.halcyonpdf.styleparser.StyleChooser
	*/
	...
	public class Style {
		...
		public function deepCopy():* {
			registerClassAlias("net.systemeD.halcyonpdf.styleparser.ShapeStyle",ShapeStyle);
			registerClassAlias("net.systemeD.halcyonpdf.styleparser.TextStyle",TextStyle);
			registerClassAlias("net.systemeD.halcyonpdf.styleparser.PointStyle",PointStyle);
			registerClassAlias("net.systemeD.halcyonpdf.styleparser.ShieldStyle",ShieldStyle);
			registerClassAlias("net.systemeD.halcyonpdf.styleparser.InstructionStyle",InstructionStyle);
